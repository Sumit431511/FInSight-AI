...
# from app.auth.auth import login_user, get_current_user
...
# def create_role(role_name: str = Form(...),user=Depends(get_current_user),):
...
# async def upload_docs(files: List[UploadFile] = File(...),role: str = Form(...),user=Depends(get_current_user)):
...
#                 (filename, role, filepath, headers_str, embedded)
#                 VALUES (?, ?, ?, ?, ?)
#                 """,
#                 (
#                     filename,
